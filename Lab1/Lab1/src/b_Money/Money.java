...
public class Money implements Comparable {
	...
	/*
	 * Here return type Integer was replaced with Double because instructions says to return amount of money
	 * in Double and Double is more suitable to keep amount of money
	 */
	...
	/*
	 * Here return type Integer was replaced with Double(same reason as in method getAmount() in class Money
	 */
	public Double universalValue() {
		return (double)(getAmount() * getCurrency().getRate());
	}
	...
	public Boolean equals(Money other) {
		double universal1 = universalValue();
		double universal2 = other.universalValue();

		return universal1 == universal2;
	}
	...
	public Money add(Money other) {
		double rate = getCurrency().getRate();
		double universal1 = universalValue();
		double universal2 = other.universalValue();
		double sumOfUniversal = universal1 + universal2;
		Double sum = sumOfUniversal/rate;
		
		return new Money((int) (sum*100), getCurrency());
	}
	...
	public Money sub(Money other) {
		...
		double universal2 = other.universalValue();
		double sumOfUniversal = universal1 - universal2;
		Integer sum = (int) (sumOfUniversal/rate);
	 ...
	 */
	public Money negate() {
		return new Money((int)(getAmount()* 100 * (-1)), getCurrency());
	}
	...
	public int compareTo(Object other) {
		double universal1 = universalValue();
		double universal2 = ((Money) other).universalValue();
		if(universal1 > universal2) {
			return 1;
		} else if (universal1 < universal2) {
			return -1;
		} else 
			return 0;
	}
